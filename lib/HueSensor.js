          ...
          case 'Signify Netherlands B.V.': {
            ...
            switch (this.obj.modelid) {
              ...
              case 'RDM002': // Hue tap dial switch
                ...
                // Always enable keypad mode and expose success MotionSensor
                this.keypad = {
                  enabled: true,
                ...
                // Optionally expose individual button services 1-4
                if (this.bridge.platform.config.tapDialButtons) {
